...
import com.eco.ecosystem.game.board.AssignNeighboursToCardsStrategy;
...
public class CardTest {
    ...
    public void setBoardAndAssignNeighbours(GamePlayer player, ArrayList<ArrayList<Card>> board){
        for(var row:board){
